...
import static day11.lambda.MappingApple.*;
...
public class Main {
    public static void main(String[] args) {
        ...
        List<Apple> filteredColorApples = FilterApple.filterApplesByColor(appleBasket, YELLOW);
        ...
        System.out.println("=========녹색이면서 100g이상=============");

        //녹색이면서 100g이상인 사과들만 필터링
        ...
        List<String> filter2 = filter(words, w -> w.length() == 3);
        ...
        System.out.println("=====사과의 색상만 매핑하기======");
        List<Color> colorList = mappingAppleColor(appleBasket);
        ...
        List<Character> map2 = map(words, w -> w.charAt(0));
        System.out.println("map2 = " + map2);

        //사과에서 무게만 매핑
        System.out.println("=======사과에서 무게만");
